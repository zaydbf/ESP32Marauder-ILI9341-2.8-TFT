...
void Display::RunSetup()
{
  ...
  tft.setCursor(0, 0);
    ...
    #ifdef TFT_SHIELD
      uint16_t calData[5] = { 275, 3494, 150, 3528, 2 }; // tft.setRotation(0); // Portrait with TFT Shield
      Serial.println(F("Using TFT Shield"));
    #else if defined(TFT_DIY)
      uint16_t calData[5] = { 339, 3470, 237, 3438, 4 }; // tft.setRotation(0); // Portrait with DIY TFT
